...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trade.cost'
        db.add_column('fprice_trade', 'cost', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Trade.cost'
        db.delete_column('fprice_trade', 'cost')
