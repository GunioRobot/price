...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.x'
        db.add_column('fprice_address', 'x', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Address.y'
        db.add_column('fprice_address', 'y', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.x'
        db.delete_column('fprice_address', 'x')

        # Deleting field 'Address.y'
        db.delete_column('fprice_address', 'y')
