...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trade.priceid'
        db.add_column('price_trade', 'priceid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['price.Price'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Trade.priceid'
        db.delete_column('price_trade', 'priceid_id')
    ...
    models = {
        ...
        'price.trade': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2'}),
            'priceid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['price.Price']", 'null': 'True', 'blank': 'True'}),
            'shop': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shop']"}),
